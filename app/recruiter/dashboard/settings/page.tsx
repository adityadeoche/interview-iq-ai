...
export default function RecruiterSettings() {
    ...
    const handleSaveProfile = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setProfileStatus({ type: 'success', text: 'Recruiter Profile updated successfully!' });
        } catch (error: any) {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            <div className="flex items-center gap-4">
                <Link href="/recruiter/dashboard" className="p-2 hover:bg-bg-secondary rounded-xl transition-all border border-border-color">
                    <ChevronLeft className="w-5 h-5" />
                </Link>
                <div>
                    <h1 className="text-2xl font-bold font-sora">Recruiter Settings</h1>
                    <p className="text-text-secondary text-sm">Manage your hiring profile and security.</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <section className="bg-bg-secondary border border-border-color rounded-3xl p-6 md:p-8">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h2 className="text-lg font-bold font-sora">Company & Profile</h2>
                    </div>
                    ...
                    <form onSubmit={handleSaveProfile} className="space-y-5">
                        ...
                        <div>
                            <label className="block text-xs font-bold uppercase tracking-widest text-text-secondary mb-2">Company Name</label>
                            <input
                                type="text"
                                value={companyName}
